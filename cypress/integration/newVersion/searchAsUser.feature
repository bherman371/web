Feature: Searching and filtering search results for a logged user

   This test verifies that the search and filters are working correctly for a logged user

    Background: 
        Given The user "stantz" is logged whit "@Galo2113" password
        And The user is seeing the news feed
