const SEARCH_INPUT = '[data-cy="new_lpSearch"]';
const SEARCH_SUBMIT = '[data-cy="new_lpSearchSubmit"]';
...
class SearchAsVisitorPage {
    ...
    static shouldSeeSearchResultPage() {
        cy.url().should('include', 'search-result-landing');
...
export default SearchAsVisitorPage;
