<template>
  <div>
    <title>Company Page - 404 Error</title>
                      ...
                      <div class="row">
                        <div class="col col-sm-3">
                          ...
                          <a class="dropdown-item" href="#">
                            Profile Page
                            <span class="tag-label bg-blue-light">new</span>
                          </a>
                          <a class="dropdown-item" href="#">Profile Page</a>
                          <a class="dropdown-item" href="#">Profile Page</a>
                          <a class="dropdown-item" href="#">Profile Page</a>
                        ...
                        <div class="col col-sm-3">
                          ...
                          <a class="dropdown-item" href="#">
                            Profile Page
                            <span class="tag-label bg-primary">HOT!</span>
                          </a>
                          <a class="dropdown-item" href="#">Profile Page</a>
                          <a class="dropdown-item" href="#">Profile Page</a>
                          <a class="dropdown-item" href="#">Profile Page</a>
            ...
            <div class="page-404-content">
              ...
              <div class="crumina-module crumina-heading align-center">
                <h2 class="h1 heading-title">
                  A
                  <span class="c-primary">wild ghost</span> appears! Sadly, not what you were looking for...
                </h2>
      ...
      <div class="modal-dialog window-popup restore-password-popup" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="get">
              <p>
                Enter your email and click the send code button. You’ll receive a code in your email. Please use that
                ...
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#home1" role="tab">
                    <svg class="olymp-login-icon">
                      <use xlink:href="/svg-icons/sprites/icons.svg#olymp-login-icon" />
                    </svg>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#profile1" role="tab">
                    <svg class="olymp-register-icon">
                      <use xlink:href="/svg-icons/sprites/icons.svg#olymp-register-icon" />
                    </svg>
                  </a>
                </li>
              </ul>
        ...
        <div class="row">
          ...
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="sub-footer-copyright">
              <span>
                Copyright
                <a href="#">Olympus Buddypress + WP</a> All Rights Reserved 2017
              </span>
            </div>
            ...
            <ul class="notification-list chat-message chat-message-field">
              <li>
                ...
                <div class="notification-event">
                  ...
                  >Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks</span>
