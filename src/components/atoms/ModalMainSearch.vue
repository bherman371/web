<template>
  <div>
    <a href="#" class="btn btn-breez btn-sm" data-toggle="modal" data-target="#main-popup-search"/>
    <div
      class="modal fade"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-inline search-form" method="post">
              ...
              <button class="btn btn-purple btn-lg">{{btnLabel}}</button>
            </form>
          </div>
        </div>
      </div>
