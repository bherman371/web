...
import ScrollMagic from "jquery";
  ...
  methods: {
	 ...
	 * ---------------------------*/
        ...
        $(".js-open-popup").on("click", function() {
          ...
          current_popup.css(
            "top",
            offset.top - current_popup.innerHeight() / 2
          );
        ...
        $window.keydown(function(eventObject) {
          if (eventObject.which == 27) {
            ...
            $('.popup-chat-responsive .modal-header').click();
        ...
        $(".js-chat-open").on("click", function() {
          $(".popup-chat-responsive-not").toggleClass("open-chat");
          return false;
        });
        $(".js-chat-close").on("click", function() {
          $(".popup-chat-responsive-not").removeClass("open-chat");
          return false;
        });
