        ...
        <div class="ui-block">
          <div class="top-header">
            <div class="top-header-thumb">
              <img v-if="headerImg" :src="headerImg" alt="nature"/>
              <img v-else src="/img/profile-header.svg"/>
            </div>
              ...
              <div class="row">
                <div class="col col-lg-5 col-md-5 col-sm-12 col-12">
                  <ul class="profile-menu">
                    <li>
                      <router-link to="/s-app/profile-page/:id">
                        <a>Timeline</a>
                      </router-link>
                    </li>
                    <li>
                      <a href="05-ProfilePage-About.html">Inventory</a>
                    </li>
                    <li>
            ...
            <div class="top-header-author">
              <a href="02-ProfilePage.html">
                <img :src="usrPicture" alt="author" class="author-thumb" />
              </a>
              <div class="author-content">
                <a href="02-ProfilePage.html" class="h4 author-name">{{userProfile.firstName}}</a>
          ...
          <div class="modal-body">
            ...
            >
              <svg class="olymp-photos-icon">
                <use xlink:href="/svg-icons/sprites/icons.svg#olymp-photos-icon" />
              </svg>
              ...
              <div class="modal-body">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="profile" role="tabpanel" aria-expanded="false">
                    ...
                    <a
                      href="#"
                      class="btn btn-primary btn-lg disabled btn--half-width"
                    >Confirm Photo</a>
                  </div>
                </div>
              </div>
...
export default {
  name: "HeaderProfile",
  props: ["userProfile", "headerImg"],
  computed: {
    usrPicture() {
      if (!this.userProfile.picture) {
        return `${Global.getServerDomain()}/images/item/2.jpg`;
      } else {
